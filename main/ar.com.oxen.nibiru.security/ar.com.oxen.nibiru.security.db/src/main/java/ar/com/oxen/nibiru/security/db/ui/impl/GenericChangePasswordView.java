...
public class GenericChangePasswordView extends
	...
	public void notifyBadOldPassword() {
		this.errorLabel.setValue(this.messageSource
				.getMessage("ar.com.oxen.nibiru.security.invalidOldPassword"));
	}

	@Override
	public void notifyPasswordMismatch() {
		this.errorLabel.setValue(this.messageSource
				.getMessage("ar.com.oxen.nibiru.security.passwordMismatch"));
	}
